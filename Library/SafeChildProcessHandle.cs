...
public sealed partial class SafeChildProcessHandle : SafeHandle
{
    ...
    /// </summary>
    /// <param name="entireProcessGroup">When true, terminates the entire process group (Unix and Windows with CreateNewProcessGroup). Default is false.</param>
    /// <returns>
    ...
    /// On Windows, when <paramref name="entireProcessGroup"/> is true and the process was started with CreateNewProcessGroup=true,
    /// terminates all processes in the job object. If the process was not started with CreateNewProcessGroup=true, 
